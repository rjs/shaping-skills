...
Complete worked examples demonstrating both breadboarding use cases.
...
> **Note:** This example uses shaping terminology. In shaping, requirements (Rs) are defined, existing patterns to reuse are identified, and a solution is sketched as parts/mechanisms. Breadboarding takes this shaped solution and details out the concrete affordances and wiring.
